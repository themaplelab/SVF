...
void SVFG::addSVFGNodesForAddrTakenVarsForPointerLevel(size_t pl, std::map<NodeID, size_t>& plMap)
{
...
void SVFG::connectIndirectSVFGEdgesForPointerLevel(size_t pl, std::map<NodeID, size_t>& plMap)
{
